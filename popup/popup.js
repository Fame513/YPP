...
const element = React.createElement("h1", null, "Hello, worlasdasdd!");
...
class AuthBtn extends React.Component {
    render() {
        return (React.createElement("button", null, "Auth"));
    }
}
...
class PasteBtn extends React.Component {
    render() {
        return (React.createElement("button", { id: 'post-btn' }, "Paste"));
    }
}
...
class Content extends React.Component {
    render() {
        return React.createElement(FileInput, null), (React.createElement(SendBtn, null), (React.createElement(AuthBtn, null), (React.createElement(LogutBtn, null), (React.createElement(PasteBtn, null), (React.createElement(NewWindowBtn, null), React.createElement(TemplateList, null))))));
    }
}
